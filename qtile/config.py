...
keys: list[Key] = [
    ...
    Key([MOD], KEYS.CAPTURE, lazy.spawn(COMMANDS.SCREENSHOT), desc="Take screenshot"),
    Key([MOD, "shift"], KEYS.CAPTURE, lazy.spawn(COMMANDS.SCREENSHOT_ANNOTATE), desc="Take screenshot with annotation"),
